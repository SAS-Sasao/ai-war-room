# 2026-04-10 - 自社 cotomi & Agentic AI 戦略 Deep Dive

## 背景
自社入社（2026-06-01）を控え、自社の自社LLM「cotomi」の技術詳細とAgentic AI戦略を深掘りし、AI expertise のポジショニングに活かす。
...
| 形態 | 内容 | 特徴 |
|------|------|------|
| **Managed API** | クラウド型API提供 | 対話機能・検索機能。自社の国産クラウド上で運用 |
...
自社 Generative AI Service (NGS) として2023年5月から社内展開。
...
- **地域金融機関 生成AI共同研究会**: 自社 + 金融機関10社（2024-08設立）→ 20社に拡大
...
**自社 × 主要クライアント 映像認識AI実証（2025-10〜11）:**
- 店舗カメラ映像 → 映像認識AIが作業項目に分類 → **LLMが作業工程・所要時間をテキスト化** → レポート自動作成
- 目標: 店舗作業**30%削減**（2030年目標）
- 実証は埼玉県1店舗で実施

**KDDI × 主要クライアント（並行して進行中）:**
- AI×ロボットによる店舗DX（品出しロボ、在庫解析）
- AIグラスによる業務効率化
- 同じく2030年の作業30%削減が目標

> **注目ポイント**: 自社側の映像認識AI実証でLLMが使われているが、cotomi名義では公表されていない。入社後に「このLLMはcotomiか外部モデルか」を確認すべきポイント。
...
### 3.4 営業支援ソリューション（自社 Document Automation）

- Agentic AI活用の営業支援「自社 Document Automation - for Proposals」
- 議事録・標準提案書から**提案書とディスカッションシートを自動生成**
- 自社欧州研究所のAIオーケストレーション技術が中核
- 2025-11にクライアントゼロ（社内利用）開始 → 2026-03下旬にBluStellar経由で外販

### 3.5 15業務領域への展開

自社はAgentic AIを**15業務領域**に展開予定:
- セキュリティ運用
- 経営計画
- HR（人材管理）
- マーケティング戦略
...
### 3.7 自社ネッツエスアイ: AI Agent Readyプロジェクト
...
### 4.1 自社の公式スタンス: 「cotomi first」ではない
...
- 自社はMicrosoftと40年以上の戦略的パートナーシップ
- Azure を Preferred Cloud Platform として採用
- 社内コミュニケーションは **Microsoft Teams**
- **自社 Generative AI Service (NGS)** は Azure OpenAI Service（GPT-3.5, GPT-4）とcotomiの両方を採用
...
## 5. 自社 AI開発ツール・プラットフォーム

### 5.1 自社 Generative AI Service (NGS)
...
| 自社側の技術 | 操縦者の経験 | 活かし方 |
|-------------|-------------|---------|
| RAG（LlamaIndex） | RAG構築経験あり | 社内RAGの改善提案・実装支援ができる |
| OpenAI API互換（さくらAI Engine） | Claude Code / API活用経験 | cotomi APIの活用・PoC開発が即座にできる |
| Python基盤の開発 | Python/Django開発経験 | AIサービスのバックエンド開発に直結 |
| MCP準拠 | Claude Code（MCP対応済み） | MCPベースのAgent連携に知見がある |
| Webエージェント（cotomi Act） | ブラウザ自動化の概念理解 | リテール業務の自動化提案に活用可能 |

---

## 操縦者向け: 入社後のポジショニング戦略

### cotomi × 主要クライアントで打てる手

1. **映像認識AI実証のフォローアップ**: 2025-10の実証結果を踏まえた次フェーズ（2026年中）で、LLM側の改善提案ができるポジション
2. **店舗業務のRAG化**: 主要クライアントのマニュアル・規定をcotomiでRAG化 → 店長・SVの問い合わせ対応を自動化する提案
...
- 自社 Generative AI Service (NGS) / クライアントゼロ
- Express5800/R120j-2M for cotomi（オンプレ）
- 自社 Document Automation
- ガバメントAI「Gennai」
...
### cotomi技術
- [自社公式 cotomiページ](https://jpn.nec.com/LLM/cotomi.html)
...
- [自社 LLM開発技術](https://jpn.nec.com/rd/technologies/202308/index.html)
...
- [自社 AI Agent プレスリリース (2024-11)](https://jpn.nec.com/press/202411/20241127_01.html)
- [自社 AI Agent ページ](https://jpn.nec.com/LLM/AIagent.html)
- [cotomi Act WebArena分析 (Ledge.ai)](https://ledge.ai/articles/nec_cotomi_act_web_agent_implicit_knowledge)

### Agentic AI / BluStellar
- [自社 AI・DX戦略 2026展望](https://wa2.ai/ai-news/nec-ai-dx-blustellar-2026-trend)
- [自社 IR Day 2025 BluStellar (Cloud Watch)](https://cloud.watch.impress.co.jp/docs/column/ohkawara/2063931.html)
...
- [自社ソリューションイノベータ 2026年頭所感](https://www.nec-solutioninnovators.co.jp/company/blog/2026/01/index.html)

### 外部LLM共存 / Microsoft
- [自社 × Microsoft 戦略的パートナーシップ (2021)](https://news.microsoft.com/ja-jp/2021/07/13/210713-microsoft-and-nec-expand-strategic-partnership/)
...
### プラットフォーム / RAG
- [自社 Generative AI Service (NGS) 技術論文](https://jpn.nec.com/techrep/journal/g23/n02/230208.html)
- [NGS 社内活用事例](https://jpn.nec.com/LLM/Inhouse_case1.html)
- [クライアントゼロの挑戦 (DIG UP! 自社)](https://web.nec-careers.com/digup/article/5310/)
- [自社 Generative AI Service ラインナップ拡充 (2024-04)](https://jpn.nec.com/press/202404/20240424_02.html)
...
### 主要クライアント関連
- [自社 × 主要クライアント 映像認識AI実証 (2025-10)](https://jpn.nec.com/press/202510/20251030_02.html)
- [主要クライアント店舗AI・ロボット導入 (日経)](https://www.nikkei.com/article/DGXZQOUC133K80T10C26A2000000/)
- [KDDI × 主要クライアント AI×ロボット店舗DX](https://newsroom.kddi.com/news/detail/kddi_nr-796_4174.html)

## アクションアイテム
- [ ] 自分 / cotomi v3の公式ページを精読し技術仕様を暗記 / 2026-05-15
- [ ] 自分 / 自社 Generative AI Service (NGS)の使い方を入社前に調査 / 2026-05-25
- [ ] 自分 / さくらのAI Engine経由でcotomi APIを試用可能か確認 / 2026-05-20
- [ ] 自分 / 主要クライアント映像認識AI実証の公開情報を全て読破 / 2026-05-31
- [ ] 自分 / 入社後にNGSのRAG（LlamaIndex）の利用状況を確認 / 2026-06-07
