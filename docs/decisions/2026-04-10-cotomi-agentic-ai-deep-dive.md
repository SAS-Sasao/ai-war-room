# 2026-04-10 - NEC cotomi & Agentic AI 戦略 Deep Dive

## 背景
NEC入社（2026-06-01）を控え、NECの自社LLM「cotomi」の技術詳細とAgentic AI戦略を深掘りし、AI expertise のポジショニングに活かす。
...
- [ ] 自分 / NEC Generative AI Service (NGS)の使い方を入社前に調査 / 2026-05-25
- [ ] 自分 / さくらのAI Engine経由でcotomi APIを試用可能か確認 / 2026-05-20
- [ ] 自分 / ローソン映像認識AI実証の公開情報を全て読破 / 2026-05-31
