...
## 背景
NEC入社（2026-06-01）を前に、BluStellarの全体構造を理解した上で、リテール（流通・小売）向けのシナリオ/オファリング体系を深掘りする。入社後に提案書を書く際の「共通言語」としてBluStellarを使いこなすことが目的。

→ 前回調査: [NEC中期経営計画・関連ニュース調査レポート](2026-04-09-nec-midterm-plan-research.md)
→ 関連Deep Dive: [cotomi & Agentic AI](2026-04-10-cotomi-agentic-ai-deep-dive.md) / [財務ブレイクダウン](2026-04-10-nec-midterm-plan-financial-breakdown.md)
...
- [ ] 自分 / NEC リテールDX(Smart Retail CX)公式を精読 / 2026-05-15
- [ ] 自分 / セブン次世代店舗システムの公開情報を全て読破 / 2026-05-20
